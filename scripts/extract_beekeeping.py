...
output_path = "/Users/marchansen/antigravity_lightrag/LightRAG/docs/beekeeping_test_data.txt"
...
try:
    ...
    for i, page in enumerate(reader.pages):
        ...
        if "beekeeping" in page_text.lower() or "beekeeper" in page_text.lower() or "honey" in page_text.lower():
            text += f"--- Page {i+1} ---\n"
            text += page_text + "\n"
